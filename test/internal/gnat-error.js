...
module.exports = function () {
    describe('GnatError', function () {
        describe('.GnatError', function () {
            describe('new GnatError()', function () {
                it('should have a `message` property.', function () {
                    const err = new GnatError.GnatError();
                ...
                it('should have a `name` property with assigned value.', function () {
                    ...
                    const err = new GnatError.GnatError('some message', 10000, name);
            ...
            describe('#getName()', function () {
                it('should return #name', function () {
                    const err = new GnatError.GnatError('msg', 10000, 'SomeError');
            ...
            describe('JSON.stringify(gnatErr)', function () {
                it('should return a brief of GnatError instance.', function () {
                    ...
                    const err = new GnatError.GnatError(message, errorCode, name, bindStack);
        ...
        describe('.setGnatErrorClass()', function () {
            it('should change the reference of `GnatError.GnatError`', function () {
                class SubError extends GnatError.GnatError {
                    subInstance () {
                        return this;
                    }
                }
                GnatError.setGnatErrorClass(SubError);
                GnatError.GnatError.should.equal(SubError);
            });
        });
    });
};
